...
/***************************************************************************************/ 
void MNDOparameter::SetArraysSizes(){
   MyMemory::Alloc1DRealArray("Parameter_MDNO",countParameter_,uss);
   MyMemory::Alloc1DRealArray("Parameter_MDNO",countParameter_,upp);
   
   MyMemory::Alloc1DRealArray("Parameter_MDNO",countParameter_,zs);

   MyMemory::Alloc1DRealArray("Parameter_MDNO",countParameter_,betaS);
   MyMemory::Alloc1DRealArray("Parameter_MDNO",countParameter_,betaP);

   MyMemory::Alloc1DRealArray("Parameter_MDNO",countParameter_,alpha);

   MyMemory::Alloc1DRealArray("Parameter_MDNO",countParameter_,gss);
   MyMemory::Alloc1DRealArray("Parameter_MDNO",countParameter_,gpp);
   MyMemory::Alloc1DRealArray("Parameter_MDNO",countParameter_,gsp);
   MyMemory::Alloc1DRealArray("Parameter_MDNO",countParameter_,gp2);
   MyMemory::Alloc1DRealArray("Parameter_MDNO",countParameter_,hsp);

   MyMemory::Alloc2DRealArray("Parameter_MDNO",countParameter_,2,dd);
   MyMemory::Alloc2DRealArray("Parameter_MDNO",countParameter_,3,pp);      

   MyMemory::Alloc1DRealArray("Parameter_MDNO",countParameter_,heat);
   MyMemory::Alloc1DRealArray("Parameter_MDNO",countParameter_,eisol);
}
/***************************************************************************************/ 
void MNDOparameter::SetParameterValues(){
// Data for Hidrogen
...
/***************************************************************************************/ 
void MNDOparameter::To_device(){
  #pragma acc enter data copyin(this[0:1],\
    this->  uss[0:countParameter_],\
    this->  upp[0:countParameter_],\
    this->   zs[0:countParameter_],\
    this->betaS[0:countParameter_],\
    this->betaP[0:countParameter_],\
    this->alpha[0:countParameter_],\
    this->  gss[0:countParameter_],\
    this->  gpp[0:countParameter_],\
    this->  gsp[0:countParameter_],\
    this->  gp2[0:countParameter_],\
    this->  hsp[0:countParameter_],\
    this->   dd[0:countParameter_],\
    this->   pp[0:countParameter_],\
    this-> heat[0:countParameter_],\
    this->eisol[0:countParameter_],\
  )
  for (unsigned int i=0;i<countParameter_;++i) {
    #pragma acc enter data copyin(this->dd[i][0:2],this->pp[i][0:3])
  }
}
/***************************************************************************************/ 
void MNDOparameter::From_device(){
  for (unsigned int i=0;i<countParameter_;++i) {
    #pragma acc exit data copyout(this->dd[i][0:2],this->pp[i][0:3])
  }
